...
<p align="left">
  <img src="./assets/game-zone/00-card.png" alt="Game Zone machine card" width="650">
</p>
...
![game zone](./assets/game-zone/game-zone.png)
...
![game zone scan](./assets/game-zone/game-zone-scan.png)
![game zone web](./assets/game-zone/game-zone-web.png)


What is the name of the large cartoon avatar holding a sniper on the forum?
Agent 47

![game zone agent](./assets/game-zone/game-zone-agent.png)
...
![or 1=1](./assets/game-zone/or-1-1.png)

When you've logged in, what page do you get redirected to?
portal.php

![game zone portal php](./assets/game-zone/game-zone-portal-php.png)


## **Using SQLMap**

![sqlmap](./assets/game-zone/sqlmap.png)
...
![game zone portal](./assets/game-zone/game-zone-portal.png)
...
![game zone sqlmap](./assets/game-zone/game-zone-sqlmap.png)
...
post
![game zone request](./assets/game-zone/game-zone-request.png)
![game zone sqlmap 1](./assets/game-zone/game-zone-sqlmap-1.png)
...
![john command](./assets/game-zone/john-command.png)
...
![game zone john pass](./assets/game-zone/game-zone-john-pass.png)
...
![game zone user flag](./assets/game-zone/game-zone-user-flag.png)


## **Exposing services with reverse SSH tunnels**


![ssh tunnel](./assets/game-zone/ssh-tunnel.png)
...
5
![ss -tulpn](./assets/game-zone/ss-tulpn.png)
...
![metasploit](./assets/game-zone/metasploit.png)
![metasploit check](./assets/game-zone/metasploit-check.png)
![game zone root flag](./assets/game-zone/game-zone-root-flag.png)
---

**Live version:** [read this write-up on my blog](https://debasjan.github.io/writeups/game-zone/)
